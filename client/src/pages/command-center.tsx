...
function getThreatBg(level: string): string {
  switch (level) {
    ...
    case "CRITICAL": return "bg-amber-500/10 text-amber-700 dark:text-amber-400 border-amber-500/20";
    case "EMERGENCY": return "bg-amber-700/20 text-amber-900 dark:text-amber-300 border-amber-500/30";
