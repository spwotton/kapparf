...
function makeNodes(): BoardNode[] {
  ...
  const nodes: Omit<BoardNode, "x" | "y" | "vx" | "vy" | "pinned">[] = [
    ...
    { id: "hall_comp", label: "1.09", category: "constant", detail: "Hall compression factor. Margaret 1970 bleed. Tacacorí receipt confirmed. The compression, not the addition. 56 years compressed into the 0.02 gap.", radius: 18 },
