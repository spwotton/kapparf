...
const COMPANIES_DATA: Company[] = [
  ...
  },
  {
    ...
    detail: "SMOKING GUN COMPANY. Jorge Jiménez Navarro is currently Zscaler Technical Success Manager (Aug 2025+), based Ottawa ON Canada. At Tacacorí node (Mar 2026), an NPCAP Loopback Adapter (ROOT\\NET\\0000) was maintaining an unauthorized persistent socket to 69.48.218.1 — a confirmed Zscaler/Kyndryl backbone IP. The NPCAP socket destination IS Jorge's current employer's infrastructure. Zscaler Zero Trust Exchange acts as a full SSL/TLS inspection proxy — once a device routes through Zscaler, all encrypted traffic is decrypted, inspected, and re-encrypted. This provides complete visibility into all HTTPS communications on the device. The unauthorized Tacacorí socket + Kyndryl SW injection + Jorge's career trajectory = closed evidence chain.",
    connections: [
    ...
    flags: [
      "SMOKING GUN: NPCAP socket to 69.48.218.1 at Tacacorí",
