...
const PERSONS: Person[] = [
  ...
  },
  {
    ...
    nationality: "German",
    role: "Rikos y Famosos property owner — former German military",
    threatLevel: "secondary",
    detail: "~80-year-old German national. Former German military — branch and specialty unknown. Owner of Rikos y Famosos property in Jacó where Echo lived for approximately 6 months in 2023. Also connected to Marveka Bikini Shop, owned by German national Magdalena. Two German nationals with adjacent property/business footprints in the same Jacó AOR where Echo was housed is not coincidental. Former military background provides: (1) operational discipline, (2) chain-of-command familiarity, (3) potential intelligence community connections from Cold War era German military-intelligence overlap. Property control over Echo's 2023 residence during the passport manipulation period places him as a key environmental controller.",
    connections: [
      ...
      { target: "j-russian", relationship: "Landlord to Echo's roommate 'J' during 2023 stay", strength: "confirmed" },
    ],
    flags: ["Former German military", "~80 years old", "Property control over Echo 2023", "Dual German-national cluster in Jacó", "Marveka Bikini Shop connection"],
  },
  {
    id: "magdalena-german",
  ...
  },
  {
    ...
    aliases: ["J"],
    nationality: "Russian",
    role: "Echo's roommate 2023 — Russian remote operative / drone expert / pianist",
    threatLevel: "primary",
    detail: "Russian national who lived with Echo for approximately 6 months at Rikos y Famosos (Wolfgang Hilbich's property), Jacó, 2023. Married to a Russian wife. Works remotely for an unknown Russian entity — employer identity unconfirmed. Demonstrated drone expertise (the 'Russian drone guy' — direct continuity link to the DJI Matrice 300 RTK detected over Jacó on 2026-05-16, 3 years later). Musical genius — witnessed playing piano with advanced cross-key improvisation technique. CRITICAL: During this co-habitation period Echo experienced: (1) manufactured 'passport issues', (2) forced visit to the Russian Embassy in San José, (3) border run to Nicaragua (or both). Passport manipulation is a documented coercion/dependency tradecraft technique — creating document crisis that forces the target to rely on the operative's network for resolution. The proximity of J's remote Russian employer + drone expertise + passport pressure during shared housing = assessment of active FSB/GRU-adjacent intelligence operation. Three-year operational continuity: 2023 co-habitation at Rikos y Famosos → 2026-05-16 drone (107.7Hz, DJI M300 RTK class) over Soul Sync Sanctuary.",
    connections: [
      { target: "rikos-famosos", relationship: "Co-resident with Echo — 2023 (6 months)", strength: "confirmed" },
      { target: "wolfgang-hilbich", relationship: "Tenant at Wolfgang's property", strength: "confirmed" },
    ...
    flags: [
      ...
      "Musical genius (piano) — possible cover identity reinforcement",
      "Russian wife — family anchor in Russian network",
