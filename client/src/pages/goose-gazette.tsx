...
Three outreach attempts were made through separate channels. Two generated read receipts. One did not. From the summit of Iztaccíhuatl, on a clear day, it is possible to see four Mexican states simultaneously. This information was not provided by the Enthusiast. It is publicly available on the mountain's Wikipedia page, which the Gazette visited at 2:14 a.m. while writing this article.`,
    ...
    },
    {
      ...
      author: "Algernon Beak, Investigations",
      date: "May 22, 2026",
      body: `ST. JOHN, USVI — Shades of Blue Charters, a pleasure cruise operation based in Cruz Bay, St. John, offers snorkeling excursions, sightseeing tours, and day trips to the British Virgin Islands aboard a World Cat 320CC power catamaran equipped with twin 300-horsepower Suzuki four-stroke outboard motors. The combined output is 600 horsepower. A standard snorkeling excursion requires, by the estimation of three marine engineers consulted for this article, between 80 and 120 horsepower. The Gazette asked the operators about the discrepancy. They said the ride was smooth.

For context: the United States Coast Guard's primary interceptor vessel in the Caribbean — the Response Boat-Medium, used for pursuit operations — is powered by twin 225-horsepower engines. Shades of Blue's snorkeling catamaran has 75 additional horsepower per side. Maritime industry sources consulted for background confirmed this configuration is "not standard for charter tourism" and is more commonly associated with vessels in categories they declined to name in print. One source said "fast" and left it at that.

The couple operating the business relocated from the mainland within the past year to establish the venture. Their closest stateside friend — a decorated veteran of two combat tours in Afghanistan, 2010 and 2011, with an intermediate deployment to Quantico, Virginia for what family members describe as sniper training — has been visiting St. John for years. He proposed to his wife there. He returns regularly. When asked by a family member to describe the island's appeal, he said it was beautiful and changed the subject.

The veteran and the charter operator have been friends for over two decades, a duration acquaintances describe as unusual given an approximate twenty-year age difference. The operator served as the veteran's best man. The friendship is described by those familiar with both as close, consistent, and not easily categorized. "They're just close," said one person. "I don't know how else to put it." They were not asked to elaborate.

The veteran currently works in sales for a commercial trucking manufacturer in Stoughton, Massachusetts, a position reached after moving, by multiple accounts, from no prior industry experience to managing the shop floor to his current role over a timeline that colleagues describe as compressed. He did not respond to requests for comment through a family intermediary. The intermediary noted his responses had become infrequent following the death of a parent in November. "Not typical of how he used to be," the intermediary said. The veteran has not responded to the intermediary either.
