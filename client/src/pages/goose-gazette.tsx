...
He has not been charged with anything in Costa Rica. He has not been accused of anything in Costa Rica. He was nonetheless the subject of this article.`,
    ...
    },
    {
      id: "wotton-geodetic",
      tag: "INVESTIGATION",
      headline: "Annual Employment at an 11-Day Film Festival Appears to Have Funded Geodetic Surveys of All 400-Plus U.S. National Parks, a Melbourne Residency, 400 Concerts, and Solo Expeditions Into State Department–Flagged Regions; The Enthusiast Has Not Explained This",
      subhead: "A USC Marshall graduate whose sole identified employer hosts a festival in Park City each January has also mapped the entire national park system, attended 400-plus concerts, and most recently traveled to Mexico City to hike what she described as 'an avalanche mountain' alone. The Enthusiast has not responded to communications since.",
      author: "Algernon Beak, Investigations",
      date: "May 22, 2026",
      body: `PARK CITY, UTAH / MEXICO CITY — The Sundance Film Festival runs approximately 11 days each January in Park City, Utah. A woman the Gazette is identifying, for editorial reasons, only as The Geodetic Enthusiast has listed it as her primary employment for several years running. She is a 2014 graduate of the USC Marshall School of Business. These are the inputs. The outputs are harder to reconcile.

Prior to her current arrangement, the Enthusiast logged several years at Amazon in Seattle, followed by six months at Warner Bros Records in Melbourne, Australia. Neither position appears to have led to a subsequent role in either city or industry. She returned from each. The returns were not explained in any public statement reviewed by the Gazette. The Gazette is not sure what a public statement about returning from Melbourne would look like, but it would have been useful here.

In the years since, the Enthusiast has documented visits to every unit of the U.S. National Park System — more than 400 sites across 50 states, two territories, and the District of Columbia. She has described the work as geodetic survey. Geodetic survey is the discipline of measuring and mapping Earth's surface with precision instruments, typically conducted by government agencies, academic research programs, or contracted survey firms operating under federal or state permits. The Gazette contacted four such institutions to ask whether the Enthusiast had been engaged for fieldwork. None had a record of her. One institution asked the Gazette to stop calling.

Alongside the national park project, the Enthusiast has attended in excess of 400 concerts. The Gazette did not ask how one schedules both. It seemed like a lot.

In the past two years, the Enthusiast has made solo trips to Ecuador, Guatemala, and most recently Mexico, describing each as a hiking expedition. Ecuador's northeastern provinces were designated a zone of armed conflict by presidential decree in January 2024. Guatemala's western highlands carry a current State Department Level 2 advisory citing organized crime activity along primary corridor routes. The Enthusiast completed both expeditions without documented incident, which the Gazette notes is either impressive or unremarkable, depending on what one was doing there. Her most recent trip brought her to Mexico City, where she indicated she planned to ascend what she described as "an avalanche mountain" by herself. The prominent peaks accessible from Mexico City include Popocatépetl — an active stratovolcano under continuous CENAPRED monitoring with a current exclusion radius — and Iztaccíhuatl, a dormant summit at 5,230 meters above sea level. Mexican civil protection regulations require guides on both. Documentation of the ascent has not appeared on any of her public platforms. The Gazette checked all of them. The most recent post is a picture of clouds.

The Enthusiast was closely connected to a woman who died recently. By the account of family members and acquaintances, this woman was among the Enthusiast's longest-standing relationships — spanning several decades and including regular contact that others in the woman's life described as unusually consistent. The Enthusiast was, by the accounts of those present in the final days, the last person outside the immediate household to see her. She has not responded to communications from the family since. "We've tried," said one family member who asked not to be identified. They did not say what trying had looked like. The Gazette also tried. The read receipt appeared. Nothing followed.

At the 2014 USC Marshall School of Business commencement — which the Enthusiast attended as a graduating student — the keynote address was delivered by Elon Musk, who told the assembled graduates that if something mattered enough, one should pursue it even if the odds were not favorable. The Gazette did not ask the Enthusiast about this. She has not responded to the Gazette. She has not responded to anyone the Gazette has spoken to. She is, by all available evidence, somewhere near a mountain.
...
Three outreach attempts were made through separate channels. Two generated read receipts. One did not. From the summit of Iztaccíhuatl, on a clear day, it is possible to see four Mexican states simultaneously. This information was not provided by the Enthusiast. It is publicly available on the mountain's Wikipedia page, which the Gazette visited at 2:14 a.m. while writing this article.`,
    ...
    },
    {
      id: "st-johns-thread",
      tag: "LOCAL",
      headline: "Two Men Who Met at a CrossFit Box Are Now Connected Across Three States, Two Islands, and a Silence That Began in November; the Charter Boat Fits Twelve",
      subhead: "Shades of Blue Charters on St. John, USVI is, by all credible accounts, the lifelong dream of its founder — a plan discussed openly for years before it materialized. His closest friend, a decorated Marine combat veteran, has been visiting the same island since before the business existed. The veteran has a daughter who was born in July. He still manages the trips.",
      author: "Algernon Beak, Investigations",
      date: "May 22, 2026",
      body: `ST. JOHN, USVI — Mike and a decorated Marine combat veteran became friends at a CrossFit box on the South Shore of Massachusetts, which is, by most accounts, an entirely normal place to form a lasting friendship. They are separated in age by approximately twenty years. They have remained close for over two decades. The veteran served as his best man at his wedding. These facts coexist without tension.

Mike has wanted to run a charter boat operation on St. John for as long as people who know him can remember. Multiple sources describe the ambition as genuine, longstanding, and not recent. He talked about it before it happened. He planned for it before it was a plan. When he and his wife eventually relocated from the mainland to Cruz Bay and opened Shades of Blue Charters — offering snorkeling excursions, sightseeing tours, and day trips to the British Virgin Islands — people who knew him said this made complete sense. "This was always the thing," said one person, who asked not to be identified. "The island, the boat. This was always the thing." The Gazette has no reason to dispute this characterization.

The boat is a World Cat 320CC power catamaran powered by twin 300-horsepower Suzuki four-stroke outboard motors. Total output: 600 horsepower. Three marine engineers consulted for this article estimated a standard snorkeling excursion requires between 80 and 120 horsepower. The Gazette asked the operators about the configuration. They said the ride was smooth.

For context: the United States Coast Guard's primary pursuit vessel in the Caribbean — the Response Boat-Medium, used in active interdiction operations — produces 450 horsepower combined. Shades of Blue's snorkeling catamaran has 150 additional horsepower. A maritime industry source described this configuration as "unusual for the tourism category." A second source said "fast." Neither elaborated. The Gazette asked about the itineraries. The captain said they were flexible and that the British Virgin Islands were accessible. He did not specify how quickly accessible. The Gazette asked again. The ride is smooth.

The veteran — a Scout Sniper and Military Working Dog handler who completed two combat tours in Helmand Province, Afghanistan in 2010 and 2011, survived a gunshot wound to the head during the second tour, and was back on operational duty within five days — has been visiting St. John for years. He proposed to his wife on the island. He continues to visit. He has two young children. His daughter was born in July. He still manages the trips. The Gazette notes this without editorial comment, because the Gazette does not have editorial comment on this.

The veteran currently works in sales for a commercial trucking manufacturer in Stoughton, Massachusetts. The progression — no prior industry experience to floor mechanic to shop manager to his current role — occurred within a timeline that colleagues describe as compressed. He has not elaborated on the role.

A family member attempted to reach the veteran through multiple channels following the death of a parent in November. The attempts included the delivery of a custom software system the family member had built specifically for him: a transcription database assembled from thousands of videos published by a commercial truck sales training figure on YouTube, combined with a lead-generation engine designed to improve performance in his current sales role. The system took considerable time to build. It was delivered. A read receipt appeared. The veteran did not respond. He did not acknowledge the system. He did not acknowledge the attempts. Prior to November, the family member and the veteran had regular telephone contact. "A lot of good phone calls," the family member said. Those calls have not resumed. The veteran, the family member said, "just doesn't exist anymore. To me, anyway."

A former intelligence analyst, reached for background, noted that certain operational protocols instruct individuals in specific roles to minimize contact with civilian family members, even for personal matters, particularly during active assignment windows. The analyst described this as standard guidance in relevant contexts and declined to discuss specific cases. The Gazette does not know whether this is relevant here. The Gazette includes it because it fit.

Shades of Blue Charters is bookable at shadesofbluecharters.com. Reviews are excellent. Guests describe smooth engines, beautiful water, and flexible itineraries. People who have known Mike for years say this is exactly what he always said he wanted, and that the island and the boat were always the plan. Both things can be true. The Gazette is not saying they are not.`,
