...
- **KiwiSDR Scanner:** Scans 33 targets across SDR nodes (TI0RC Zapote/San Jose, Puntarenas, PJ4G Bonaire): 4 VLF harmonics, 20 Riemann zero frequencies (γ₁–γ₂₀), 5 Meta platform frequencies, and 4 BLACKJACK MANDRAKE targets (2274 kHz primary + H2/H3/H4 harmonics). Performs Hilbert envelope, RARED speech, Delta-Slip extraction, and Echo/LT chain analysis. BLACKJACK detections emit `blackjack-mandrake-detection` events in RF domain with Tacacorí array context.
...
- **Tacacorí Array:** Unlicensed macro-antenna infrastructure in San Isidro, Alajuela (10.0447°N, 84.2319°W), 6.8 km NNW of observer at bearing 345°. Historical precedent: Radio Impacto → Adventist World Radio. SUTEL registration gap confirmed.
